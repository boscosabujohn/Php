...
<div class="container-fluid py-4" style="max-width:100vw;">
    ...
    <div class="card p-2 mb-3">
        <div class="row g-2 align-items-center mb-2">
            <div class="col-md-4">
                <input type="text" id="generalSearch" class="form-control" placeholder="Search users..." style="font-size:1em;">
            </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover align-middle" id="usersTable" style="font-size:0.98em;">
                <thead>
                    <tr>
                        <th>Name</th>
                        <th>Email</th>
    ...
    <div class="card p-2 form-section" id="userFormSection" style="display:none;">
        <h5 id="formTitle" style="font-size:1.1rem;">Add User</h5>
        <form id="userForm" autocomplete="off">
            ...
            <div class="row g-2 mt-2">
                ...
                <div class="col-md-6">
                    <label class="form-label mb-1">Password <span class="text-danger" id="passwordRequired">*</span></label>
            ...
            <div class="row g-2 mt-2">
                ...
                <div class="col-md-4">
                    <label class="form-label mb-1">Skills</label>

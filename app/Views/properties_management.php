...
<div class="container-fluid py-4" style="max-width:100vw;">
    ...
    <div class="card-enhanced p-3 mb-4">
        <div class="card-enhanced-header mb-3">
            <h5 class="card-enhanced-title mb-0">Search & Filter Properties</h5>
        </div>
    ...
    <div class="card-enhanced">
        <div class="card-enhanced-header">
            <h5 class="card-enhanced-title mb-0">Property Directory</h5>
        </div>
    ...
    <div class="form-enhanced mt-4" id="propertyFormSection" style="max-width:800px;margin-left:auto;margin-right:auto;">
        <h5 id="formTitle" class="mb-4" style="font-size:1.25rem;font-weight:700;">Add Property</h5>

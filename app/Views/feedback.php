...
<div class="container py-4">
    <div class="card p-3 mx-auto" style="max-width:500px;">
        ...
        <form id="feedbackForm">
            ...
            <div class="mb-2">Please rate the service and provide your comments.</div>
...
$('#feedbackForm').on('submit', function(e) {
    ...
    $.post(apiUrl + 'create', { table: 'fms_request_feedback', data: { request_id: requestId, rating, comments } }, function() {
        $('#formMessage').removeClass('text-danger').addClass('text-success').text('Thank you for your feedback!');
        setTimeout(() => { window.location.href = '/tenant_portal'; }, 1200);
    }).fail(function() {

<!-- Technician Skills Management UI (CRUD, Themed, Responsive) -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Technician Skills Management</title>
    ...
    <style>
        ...
        .form-section { margin-top: 2rem; max-width: 500px; margin-left: auto; margin-right: auto; }
...
<div class="container-fluid py-4" style="max-width:100vw;">
    ...
    <div class="card p-2 form-section" id="skillFormSection">
        <h5 id="formTitle" style="font-size:1.1rem;">Add Skill</h5>
        <form id="skillForm" autocomplete="off">
            <input type="hidden" id="skillId">
            <div class="mb-2">
                <label class="form-label mb-1">Name <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="skillName" required style="font-size:1em;">
            </div>
            <div class="mt-3 d-flex gap-2">
                <button type="submit" class="btn btn-primary" id="saveSkillBtn">Save</button>
                <button type="button" class="btn btn-secondary" id="cancelFormBtn">Cancel</button>
            </div>
            <div id="formMessage"></div>
        </form>
    </div>
    <button class="floating-btn" id="addSkillBtn" title="Add Skill">+</button>
</div>
<!-- Confirmation Modal -->
...
<script>
// ... JS logic for loading, filtering, CRUD for skills will go here ...
</script>
</body>
</html>
